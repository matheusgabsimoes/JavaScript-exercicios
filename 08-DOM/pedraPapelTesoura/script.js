...
function updateElementoPlacar() {
   document.querySelector('.updatePlacar') 
   .innerHTML = `Vitórias: ${placar.vitorias}, Derrotas: ${placar.derrotas}, Empates: ${placar.empates}`;
}
